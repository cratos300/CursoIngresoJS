    ...
    if(datito != -1 )
    {
        ...
        if(buscador!= -1 && lista[datito].id == listaEs[buscador].Identificador)
        {
            ...
            if(respuesta == 's')
            {
                ...
                while(horaSalida < listaEs[buscador].HorarioDeEntrada)
                {
                    printf("\nError, no te podes quedar mas de 1 dia :D Reingrese:");
                    scanf("%d",&horaSalida);
                }
    ...
    else
    {
        ...
        if(topo != -1)
        {
            ...
            else
            {
                ...
                while(lista[indice].HorarioDeEntrada > 24)
                {
                    printf("Ingrese el horario de entrada");
                    fflush(stdin);
                    scanf("%d",&lista[indice].HorarioDeEntrada);
